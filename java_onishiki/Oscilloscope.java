...
public class Oscilloscope implements MessageListener
{
    ...
    public int ill1 = 0, ill2 = 0, ill3 = 0;
...
*/
	...
	System.out.println(omsg.get_id()+":"+dataint[0]);
	...
	int second = cal1.get(Calendar.SECOND);    
		...
		try{
			//File file0 = new File("sensor.txt");
        		...
        		//pw.close();
                        ...
                        ill1 = (int)(2.285*dataint[0]-11.4);
			File file =new File("logNo1_722.txt");
			FileWriter filewriter=new FileWriter(file,true);
			//filewriter.write(year+","+month+","+day+","+hour+","+minute+","+second+","+dataint[0]+","+ill1+"\r\n");
			filewriter.write(DF.format(date1)+","+dataint[0]+","+ill1+"\r\n");
			filewriter.close();
		}
		catch (Exception e){
		}
	}
	else if(omsg.get_id()==2){
		try{
			//File file0 = new File("sensor.txt");
        		//PrintWriter pw = new PrintWriter(new BufferedWriter(new FileWriter(file0,true)));
        		//pw.print(dataint[0]+",");
        		//pw.close();
                        ill2 = (int)(2.096*dataint[0]+17);
			File file =new File("logNo2_623.txt");
			FileWriter filewriter=new FileWriter(file,true);
			filewriter.write(year+","+month+","+day+","+hour+","+minute+","+second+","+dataint[0]+","+ill2+"\r\n");
			filewriter.close();
		}
		catch (Exception e){
		}
        ...
        try{
                File file1 = new File("ILS_okunishi/sensor.txt");
		...
		pw.print(dataint[0] + "," + dataint[1] + "," + dataint[2]);
                ...
                Date date2 = new Date();
                SimpleDateFormat DF = new SimpleDateFormat("yyyy,MM,dd,HH,mm,ss.SSS");
		File file =new File("log/log_sensors.txt");
		FileWriter filewriter=new FileWriter(file,true);
		//filewriter.write(year+","+month+","+day+","+hour+","+minute+","+second+","+dataint[0]+","+ill1+"\r\n");
